...
void ASCharacter::BeginPlay()
{
	...
	if( GetLocalRole() == ROLE_Authority)
	{
		...
		GM->ChessSolved.AddDynamic(this, &ASCharacter::ChessSolved);
	}
...
{
	UE_LOG(LogTemp, Log, TEXT("character Health %s of %s"), *FString::SanitizeFloat(Health), *GetName());
...
void ASCharacter::ChessSolved(AActor* Solver, AController* SolvedController)
{
	GetMovementComponent()->StopMovementImmediately();
